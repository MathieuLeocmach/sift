...
In contrast to a crystal where all the particles are equivalent, the roles of the particle at the centre of an icosahedron and of the particles surrounding it are asymmetric. The size distribution of the particles at the surface of icosahedra is rather close to the \textsc{mrco} with less small particles than average. The size distribution of the particles at the center of icosahedra features a low main peak and a second peak, absent in all the other species, about at $80\%$ smaller radii. The tail at small sizes is comparable to the overall size distribution. A centre to surface size ratio of $0.8$ seems to stabilize icosahedral order.
