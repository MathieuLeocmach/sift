...
\begin{figure}
	...
	We note that the detection failure near the boundaries is not due to the deficiency of our method. (b) Nucleation under phase contrast microscope. The circles are the result of our algorithm.}
...
We are grateful to John Russo for providing us with simulation data of dense hard spheres, which are used in Fig. 3e, 
to Anthony Genot for providing an image of Fig. 2a, to Ken-ichiro Murata for providing an image of Fig. 2b, and to Rebecca Rice and C. Paddy Royall 
