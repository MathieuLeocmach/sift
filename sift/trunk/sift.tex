...
Combining our definition of $\sigma$ (Eq.~(\ref{eq:sigma_i})) and Eq.~\ref{eq:R_dilute}, we find that at infinite dilution the scale $\sigma$ is simply proportional to the radius $R$ of the particle, with a proportionality constant that depends only on the sampling rate $n$ of the scale space:
\begin{equation}
