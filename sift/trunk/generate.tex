...
\begin{figure}
	...
	\begin{tikzpicture}[
		...
		{%
			\includegraphics[width=0.29\columnwidth]{anim_small_boo000.png} & %
			\includegraphics[width=0.29\columnwidth]{anim_small_boo060.png} & %
			\includegraphics[width=0.29\columnwidth]{anim_small_boo120.png}\\
			\includegraphics[width=0.29\columnwidth]{anim_small_boo180.png} & %
			\includegraphics[width=0.29\columnwidth]{anim_small_boo240.png} & %
			\includegraphics[width=0.29\columnwidth]{anim_small_boo299.png}\\%
		};
		\begin{axis}[%
		name=b,
		at={(a.south east)},%
